...
public class Mod {
    ...
    private static com.example.tahaweyplccontrol.Mod mod;
    ...
    public void config(EndPoint endpoint) throws UnknownHostException {
        if (mod == null) {
            mod = new com.example.tahaweyplccontrol.Mod();
        }
    ...
    public static com.example.tahaweyplccontrol.Mod getInstance() {
        if (mod == null) {
            mod = new com.example.tahaweyplccontrol.Mod();
        }
        return mod;
